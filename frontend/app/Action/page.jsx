...
function App() {
    ...
    const fetchMovies = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/genre/Action`);
    ...
    return (
        <div className="min-h-screen text-white bg-black">
            ...
            <main className="mx-[3vw] mt-4 sm:mx-[5vw] ">
                <h1 className="text-3xl font-semibold text-center text-white">Discover Thrilling Action: Reviews, Ratings & Recommendations
                </h1>
                <p className='text-center text-gray-300 w-[70vw] mx-auto py-2'>
                    Unleash your adrenaline with our action page! From pulse-pounding blockbusters to legendary action-packed sagas, explore reviews, ratings, and must-watch recommendations designed for every action aficionado.</p>
