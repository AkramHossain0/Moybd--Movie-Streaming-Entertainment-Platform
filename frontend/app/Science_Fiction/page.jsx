...
function App() {
    ...
    const fetchMovies = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/genre/Science_Fiction`);
        ...
        <div className="min-h-screen text-white bg-black">
            ...
            <main className="mx-[3vw] mt-4 sm:mx-[5vw] ">
                <h1 className="text-3xl font-semibold text-center text-white">
                    Explore the Future: Science Fiction Reviews, Ratings & Recommendations

                </h1>
                <p className='text-center text-gray-300 w-[70vw] mx-auto py-2'>
                    Venture into the unknown with our science fiction page! From futuristic worlds to mind-bending concepts, discover reviews, ratings, and must-watch recommendations that challenge reality and ignite your imagination.
                </p>
