...
function App() {
    ...
    const fetchMovies = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/genre/Crime`);
    ...
    return (
        <div className="min-h-screen text-white bg-black">
            ...
            <main className="mx-[3vw] mt-4 sm:mx-[5vw] ">
                <h1 className="text-3xl font-semibold text-center text-white">Uncover Gripping Crime Stories: Reviews, Ratings & Recommendations</h1>
                <p className='text-center text-gray-300 w-[70vw] mx-auto py-2'>
                    Step into the world of mystery and intrigue with our crime page! From edge-of-your-seat thrillers to masterful whodunits, explore reviews, ratings, and must-watch recommendations crafted for every crime genre enthusiast.</p>
