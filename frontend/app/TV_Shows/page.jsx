...
function App() {
    ...
    const fetchMovies = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/dashboard/tvshows`);
        ...
        <div className="min-h-screen text-white bg-black">
            ...
            <main className="mx-[3vw] mt-4 sm:mx-[5vw] ">
                <h1 className="text-3xl font-semibold text-center text-white">
                    Explore Top TV Shows Series: Reviews, Ratings & Recommendations
                </h1>
                <p className='text-center text-gray-300 w-[70vw] mx-auto py-2'>
                Discover the best TV shows across genres! From timeless classics to the latest sensations, dive into detailed reviews, ratings, and must-watch recommendations. Your next binge-worthy favorite awaits!
                </p>
