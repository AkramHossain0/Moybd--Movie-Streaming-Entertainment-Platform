...
function App() {
    ...
    const fetchMovies = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/genre/Romance`);
        ...
        <div className="min-h-screen text-white bg-black">
            ...
            <main className="mx-[3vw] mt-4 sm:mx-[5vw] ">
                <h1 className="text-3xl font-semibold text-center text-white">
                    ...
                    Fall in Love: Romance Reviews, Ratings & Recommendations
                </h1>
                <p className='text-center text-gray-300 w-[70vw] mx-auto py-2'>
                    Indulge in heartwarming tales with our romance page! From passionate love stories to unforgettable connections, explore reviews, ratings, and must-watch recommendations that will sweep you off your feet.
                </p>
