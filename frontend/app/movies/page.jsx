...
function App() {
  ...
  return (
    <div className="min-h-screen text-white bg-black">
      ...
      <h1 className="text-3xl font-semibold text-center text-white">Explore Top Movies: Reviews, Ratings & Recommendations</h1>
            <p className='text-center text-gray-300 w-[70vw] mx-auto py-2'>
                Dive into the world of cinema with our movie page! From timeless classics to the latest blockbusters, explore reviews, ratings, and must-watch recommendations tailored for every movie enthusiast.
            </p>
