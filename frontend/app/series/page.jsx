...
function App() {
  ...
  return (
    <div className="min-h-screen text-white bg-black">
      ...
      <h1 className="text-3xl font-semibold text-center text-white">Explore Top Series: Reviews, Ratings & Recommendations</h1>
            <p className='text-center text-gray-300 w-[70vw] mx-auto py-2'>
            Immerse yourself in the world of captivating series with our series page! From binge-worthy classics to the latest trending shows, uncover detailed reviews, ratings, and must-watch recommendations tailored for every series enthusiast.            </p>
