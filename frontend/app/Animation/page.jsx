...
function App() {
    ...
    const fetchMovies = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/genre/Animation`);
    ...
    return (
        <div className="min-h-screen text-white bg-black">
            ...
            <main className="mx-[3vw] mt-4 sm:mx-[5vw] ">
                <h1 className="text-3xl font-semibold text-center text-white">Explore the World of Animation: Reviews, Ratings & Recommendations
                </h1>
                <p className='text-center text-gray-300 w-[70vw] mx-auto py-2'>
                Dive into the vibrant realm of animation with our page dedicated to animated masterpieces! From stunning visuals to captivating storytelling, discover reviews, ratings, and must-watch recommendations for every animation lover.
                </p>
