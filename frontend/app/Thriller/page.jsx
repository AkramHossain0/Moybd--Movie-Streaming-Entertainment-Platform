...
function App() {
    ...
    const fetchMovies = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/genre/Thriller`);
        ...
        <div className="min-h-screen text-white bg-black">
            ...
            <main className="mx-[3vw] mt-4 sm:mx-[5vw] ">
                <h1 className="text-3xl font-semibold text-center text-white">
                    Get Your Heart Racing: Thriller Reviews, Ratings & Recommendations
                </h1>
                <p className='text-center text-gray-300 w-[70vw] mx-auto py-2'>
                    Prepare for suspense and excitement with our thriller page! From high-stakes mysteries to pulse-pounding twists, explore reviews, ratings, and must-watch recommendations that will keep you on the edge of your seat.
                </p>
