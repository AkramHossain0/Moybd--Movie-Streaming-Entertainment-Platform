...
function App() {
    ...
    const fetchMovies = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/genre/Comedy`);
    ...
    return (
        <div className="min-h-screen text-white bg-black">
            ...
            <main className="mx-[3vw] mt-4 sm:mx-[5vw] ">
                <h1 className="text-3xl font-semibold text-center text-white">Laugh Out Loud: Comedy Reviews, Ratings & Recommendations</h1>
                <p className='text-center text-gray-300 w-[70vw] mx-auto py-2'>
                    Step into the world of humor with our comedy page! From timeless classics to the latest laugh-out-loud hits, explore reviews, ratings, and must-watch recommendations guaranteed to tickle your funny bone.</p>
