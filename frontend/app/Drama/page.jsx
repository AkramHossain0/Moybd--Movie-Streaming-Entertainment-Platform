...
function App() {
    ...
    const fetchMovies = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/genre/Drama`);
    ...
    return (
        <div className="min-h-screen text-white bg-black">
            ...
            <main className="mx-[3vw] mt-4 sm:mx-[5vw] ">
                <h1 className="text-3xl font-semibold text-center text-white">Dive into Emotion: Drama Reviews, Ratings & Recommendations</h1>
                <p className='text-center text-gray-300 w-[70vw] mx-auto py-2'>
                    Experience the depth of storytelling with our drama page! From heart-wrenching tales to powerful performances, explore reviews, ratings, and must-watch recommendations that capture the essence of human emotions.</p>
