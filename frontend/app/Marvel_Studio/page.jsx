...
function App() {
    ...
    const fetchMovies = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/dashboard/marvelstudio`);
        ...
        <div className="min-h-screen text-white bg-black">
            ...
            <main className="mx-[3vw] mt-4 sm:mx-[5vw] ">
                <h1 className="text-3xl font-semibold text-center text-white">
                    Explore Top Marvel Series: Reviews, Ratings & Recommendations
                </h1>
                <p className='text-center text-gray-300 w-[70vw] mx-auto py-2'>
                Step into the Marvel Universe! Explore thrilling series packed with superheroes, epic battles, and captivating stories. Get detailed reviews, ratings, and must-watch recommendations for every Marvel fan. Assemble your watchlist now!
                </p>
